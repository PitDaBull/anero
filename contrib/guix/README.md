# Bootstrappable Anero Builds

This directory contains the files necessary to perform bootstrappable Anero 
builds.
...
To build Anero reproducibly with all default options, invoke the
...
repository](https://github.com/anero-project/guix.sigs).
