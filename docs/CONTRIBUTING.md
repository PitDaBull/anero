...
posted to #anero-dev on irc.libera.chat).
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Anero code or Anero's dependency code or Anero's potential/future dependency code or research which successfully implements Anero.
...
- Maintainers SHOULD NOT merge their own patches unless they were added to the merge queue on irc and have at least 3 approvals from contributors OR unless urgent as defined by the Anero Maintainers Team.
...
- The Anero Core Team MUST act as Administrators to manage the set of project Maintainers.
