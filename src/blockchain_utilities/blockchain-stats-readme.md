# Anero Blockchain Stats

Anero Blockchain Stats utlity exports daily statistics for the anero blockchain from creation through current state.

## Usage:

See also the utility's help option. `anero-blockchain-stats --help`
...
- `anero-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `anero-blockchain-stats | save-to-database.sh`
